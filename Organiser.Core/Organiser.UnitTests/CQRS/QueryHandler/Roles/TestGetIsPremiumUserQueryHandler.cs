...
{
    [TestFixture]
    public class TestGetIsPremiumUserQueryHandler
    {
        ...
        [Test]
        public void TestGetIsPremiumUserQueryHandler_UserNotFound_ShouldReturnFalse()
        {
            //Arrange
            user.Setup(x => x.UID).Returns(9);

            var query = new GetIsPremiumUserQuery();
            var handler = new GetIsPremiumUserQueryHandler(context.Object, user.Object);
        ...
        [Test]
        public void TestGetIsPremiumUserQueryHandler_UserIsUser_ShouldReturnTrue()
        {
            //Arrange
        ...
        [Test]
        public void TestGetIsPremiumUserQueryHandler_UserIsPremium_ShouldReturnTrue()
        {
            //Arrange
        ...
        [Test]
        public void TestGetIsPremiumUserQueryHandler_UserIsSupport_ShouldReturnFalse()
        {
            //Arrange
        ...
        [Test]
        public void TestGetIsPremiumUserQueryHandler_UserIsAdmin_ShouldReturnFalse()
        {
            //Arrange
